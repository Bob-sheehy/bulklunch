...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { location: @deal.location, name: @deal.name, price: @deal.price } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { location: @deal.location, name: @deal.name, price: @deal.price } }
